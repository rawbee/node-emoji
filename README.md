...
Note: This is a clone of [node-emoji](https://www.npmjs.com/package/node-emoji), with support for latest emoji.

## Installation
To install `roopakv/node-emoji`, you need [node.js](http://nodejs.org/) and [npm](https://github.com/npm/npm#super-easy-install). :rocket:

Once you have that set-up, just run `npm install --save roopakv/node-emoji` in your project directory. :ship:

You're now ready to use emoji in your node projects! Awesome! :metal:

## Usage
```javascript
var emoji = require('roopakv/node-emoji')
